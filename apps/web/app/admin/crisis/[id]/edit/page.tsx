    ...
    return (
        <div className="p-8 bg-[#2B3337] min-h-screen flex justify-center items-start">
            <div className="w-full max-w-2xl bg-[#1e2427] p-10 border border-[#8E1616]/20 shadow-2xl relative">
                ...
                <button onClick={() => router.back()} className="text-[10px] text-[#CCCCCC]/40 hover:text-white   font-bold tracking-widest mb-6 flex items-center gap-2">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        <h1 className="text-3xl font-serif font-bold text-white     tracking-tighter">Éditer l'Alerte</h1>
                        <p className="text-[10px] text-[#CCCCCC]/50   tracking-widest font-bold font-mono">CRISIS_REF: {id?.toString().slice(-8)}</p>
                    </div>
                </div>
