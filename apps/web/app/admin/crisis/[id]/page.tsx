...
export default function CrisisDetails() {
    ...
    if (!crisis) return (
        <div className="p-8 bg-[#2B3337] min-h-screen text-white flex items-center justify-center animate-pulse   tracking-[0.5em]">
    ...
    return (
        <div className="p-8 bg-[#2B3337] min-h-screen text-[#CCCCCC]">
            <div className="max-w-5xl mx-auto">
                {/* Navigation retour */}
                <button onClick={() => router.push('/admin/crisis')} className="flex items-center gap-2 text-[#D84040] hover:text-white mb-8 transition-colors   text-[10px] font-black tracking-widest">
                ...
                <div className="bg-[#1e2427] border border-[#8E1616]/30 overflow-hidden shadow-2xl">
                    ...
                    <div className="bg-[#8E1616]/20 p-8 border-b border-[#8E1616]/30 flex justify-between items-center">
                        <div>
                            <h1 className="text-4xl font-serif font-bold text-white     tracking-tighter">{crisis.title}</h1>
                            <p className="text-[10px] text-[#D84040] font-black   tracking-[0.3em] mt-2 flex items-center gap-2">
                                <Clock size={12} /> ID: {id}
                            </p>
                        </div>
                        <div className={`px-6 py-2 border ${crisis.status === 'EN_COURS' ? 'border-[#D84040] text-[#D84040]' : 'border-green-500 text-green-500'} font-black   tracking-widest text-sm`}>
                            {crisis.status}
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#8E1616]/20">
                        ...
                        <div className="md:col-span-2 p-8">
                            <h3 className="text-[10px]   font-black text-[#D84040] tracking-widest mb-4 flex items-center gap-2">
                        ...
                        <div className="p-8 space-y-8 bg-black/10">
                            ...
                            <div>
                                <h3 className="text-[10px]   font-black text-[#D84040] tracking-widest mb-2">Niveau de Sévérité</h3>
                    ...
                    <div className="p-8 border-t border-[#8E1616]/20 flex flex-wrap gap-4">
                        <button
                            ...
                            className="bg-white/5 hover:bg-white/10 text-white px-8 py-3 font-bold   tracking-widest text-xs transition-all border border-white/10"
                        >
                        ...
                        <button
                            ...
                            className="bg-[#D84040] hover:bg-[#8E1616] text-white px-8 py-3 font-bold   tracking-widest text-xs transition-all shadow-lg flex items-center gap-2"
                        >
