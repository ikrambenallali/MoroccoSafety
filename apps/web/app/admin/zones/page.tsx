        ...
        <div className="p-8 bg-[#2B3337] min-h-screen text-[#CCCCCC]">
            ...
            <div className="flex justify-between items-center mb-10 border-b border-[#8E1616]/30 pb-6">
                ...
                <button
                    ...
                    className="bg-[#D84040] text-white px-6 py-3 rounded-sm flex items-center gap-2 font-black   tracking-[0.2em] text-[10px] transition-all shadow-lg border border-white/10"
                >
