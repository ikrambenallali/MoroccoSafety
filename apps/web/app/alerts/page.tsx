              ...
              <tr key={a._id} className="hover:bg-white/5 transition-colors group">
                <td className="p-5">
                  <div className="flex flex-col">
                    <span className="font-bold text-white   tracking-tight text-sm">{a.title}</span>
                ...
                <td className="p-5 text-center">
                  <div className="flex items-center justify-center gap-2">
                    {a.sent ? (
                      <span className="flex items-center gap-1 text-green-500 text-[10px] font-black   tracking-widest">
                        <CheckCircle size={12} /> Diffusé
                      </span>
                    ) : (
                      <span className="flex items-center gap-1 text-yellow-500 text-[10px] font-black   tracking-widest animate-pulse">
                ...
                <td className="p-5 text-right">
                  {!a.sent ? (
                    <button
                      ...
                      className="bg-[#D84040] hover:bg-[#8E1616] text-white px-4 py-2 rounded-sm text-[10px] font-black   flex items-center gap-2 transition-all ml-auto shadow-lg border border-white/10"
                    >
                      <Send size={14} /> Envoyer
                    </button>
                  ) : (
                    <span className="text-[10px] text-white/20   font-bold   tracking-widest">Archivé</span>
                  )}
                </td>
              </tr>
            ))}
            {alerts.length === 0 && (
              <tr>
                <td colSpan={4} className="p-16 text-center opacity-20">
                  ...
                  <p className="text-[10px] font-black   tracking-[0.4em]">Aucun message dans la file d'attente</p>
                </td>
              </tr>
            )}
          </tbody>
