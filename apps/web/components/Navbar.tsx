        ...
        <nav className="bg-[#D84040] text-white h-16 px-8 flex justify-between items-center shadow-[0_4px_20px_rgba(216,64,64,0.25)] z-40 relative">
            ...
            <div className="flex items-center gap-4">
                <div className="hidden md:flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full border border-white/20">
                    ...
                    <span className="text-[10px]   tracking-widest font-bold">Système de Vigilance Actif</span>
                </div>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-[#8E1616] hover:bg-black/20 px-4 py-2 rounded-sm text-xs   tracking-[0.2em] font-black transition-all duration-300 border border-white/10 shadow-lg group"
                >
