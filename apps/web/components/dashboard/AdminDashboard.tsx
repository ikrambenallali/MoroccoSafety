        ...
        <div className="p-8 bg-[#2B3337] min-h-screen text-[#CCCCCC] space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className={statCardStyle}>
                    ...
                    <h2 className="text-[10px] uppercase tracking-[0.2em] font-black text-[#CCCCCC]/60">Total Crises</h2>
                    <p className="text-5xl font-serif font-bold text-white mt-2 italic">{overview.crisis || 0}</p>
                </div>

                <div className={statCardStyle}>
                    <div className="absolute top-0 left-0 w-1 h-full bg-[#D84040]"></div>
                    <Activity className="text-[#D84040] mb-2 opacity-50" size={20} />
                    <h2 className="text-[10px] uppercase tracking-[0.2em] font-black text-[#CCCCCC]/60">Alertes Actives</h2>
                    <p className="text-5xl font-serif font-bold text-white mt-2 italic">{overview.alerts || 0}</p>
                </div>

                <div className={statCardStyle}>
                    <div className="absolute top-0 left-0 w-1 h-full bg-[#D84040]"></div>
                    <FileText className="text-[#D84040] mb-2 opacity-50" size={20} />
                    <h2 className="text-[10px] uppercase tracking-[0.2em] font-black text-[#CCCCCC]/60">Rapports Citoyens</h2>
                    <p className="text-5xl font-serif font-bold text-white mt-2 italic">{overview.reports || 0}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#1e2427] border border-[#8E1616]/20 p-8 shadow-2xl relative">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-lg font-serif font-bold text-white italic uppercase tracking-tight">Répartition par Type</h2>
                ...
                <div className="bg-[#1e2427] border border-[#8E1616]/20 p-8 shadow-2xl relative">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-lg font-serif font-bold text-white italic uppercase tracking-tight">Temps moyen de réponse</h2>
                    ...
                    <p className="text-[9px] uppercase tracking-widest text-[#CCCCCC]/30 mt-4 text-center">Données exprimées en heures moyennes</p>
                </div>
            ...
            <div className="flex justify-center items-center gap-4 opacity-20">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.5em]">System Status: Nominal</span>
                <div className="h-[1px] w-20 bg-[#D84040]"></div>
            </div>
        </div>
    )
